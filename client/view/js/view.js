...
class Vista {
	constructor() {
		this.stack = []; //pila de pantallas, para navegación
	}

	/**
	 * Para profundizar en el esquema de navegación de pantallas
	 * guarda el nombre de la pantalla actual en la pila
	 * @param {*} pantalla : NOmbre de la plantilla de pantalla a mostrar
	 */
	...
	/**
	 * Para retorceder en el esquema de navegación de pantallas
	 * retirar el nombre de la pantalla actual de la pila
	 * y muestra la pantalla anterior
	 */
	retrocederPantalla() {
